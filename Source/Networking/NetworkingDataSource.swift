...
extension JXPhotoBrowser {
    public class NetworkingDataSource: NSObject, JXPhotoBrowserDataSource {
        ...
        public func registerCell(for collectionView: UICollectionView) {
            collectionView.jx.registerCell(NetworkingCell.self)
        }
        ...
        public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = collectionView.jx.dequeueReusableCell(NetworkingCell.self, for: indexPath)
            // 一级资源
