...
extension JXPhotoBrowser {
    open class RawImageDataSource: NSObject, JXPhotoBrowserDataSource {
        /// 弱引用 PhotoBrowser
        ...
        public func registerCell(for collectionView: UICollectionView) {
            collectionView.jx.registerCell(RawButtonCell.self)
        }
        ...
        public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = collectionView.jx.dequeueReusableCell(RawButtonCell.self, for: indexPath)
            // 一级资源
