...
extension JXPhotoBrowser {
    open class Transitioning: NSObject, JXPhotoBrowserTransitioningDelegate {
        ...
        private weak var presentCtrl: PresentationController?
        ...
        public func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
            let ctrl = PresentationController(presentedViewController: presented, presenting: presenting)
            presentCtrl = ctrl
            return ctrl
        }
    }
